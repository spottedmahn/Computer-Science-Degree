...
public class AllCreator{
	...
	public AllCreator(){
		...
		filesALBUMSCar = new String[5];
		
		filesALBUMSCar[0] = "\\\\musicfactory\\network_website\\albums_#-c_car.htm";
		filesALBUMSCar[1] = "\\\\musicfactory\\network_website\\albums_d-h_car.htm";
		filesALBUMSCar[2] = "\\\\musicfactory\\network_website\\albums_i-m_car.htm";
		filesALBUMSCar[3] = "\\\\musicfactory\\network_website\\albums_n-s_car.htm";
		filesALBUMSCar[4] = "\\\\musicfactory\\network_website\\albums_t-z_car.htm";	
	...
	public void createALBUMSAll() throws IOException{
		...
		for(int i=0;i<filesALBUMS.length;i++){
			...
			BufferedReader fileReaderCar = new BufferedReader(new FileReader(filesALBUMSCar[i]));
