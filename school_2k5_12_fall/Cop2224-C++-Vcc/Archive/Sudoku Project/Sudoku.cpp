...
bool Sudoku::solve(){
     ...
     if(isSolved()){
          ...
          //otherwise un-wind guess
               ...
               currentBoard.data[tmpCell.row][tmpCell.col] = prevData;
               removeElem(tmpCell);
               solve();
          }     
...
void Sudoku::makeMove(oneCell cellIn){
     ...
     updateCandiateListWrapper(cellIn);

} 
  
void Sudoku::updateCandiateListWrapper(oneCell cellIn){
      
        updateCandiateListRow(cellIn.row, cellIn.col);

        updateCandiateListCol(cellIn.row, cellIn.col);

        updateCandiateListQuadrand(cellIn.row, cellIn.col);        
        
        fout << "wrapperCount == " << wrapperCount << endl;
...
void Sudoku::updateCandiateListRow(int rowIn, int colIn){
...
void Sudoku::updateCandiateListCol(int rowIn, int colIn){
...
void Sudoku::updateCandiateListQuadrand(int rowIn, int colIn){
